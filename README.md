...
│   ├── decor-sakura.svg          页面顶部的樱花装饰插画（无需理会，可删除即隐藏装饰）
│   └── photo-*.jpg               ★ 你要添加的真实照片放在这里，文件名见第六节表格
...
| 讲师紹介 teachers.html | `photo-teachers-banner.jpg` | 横版 21:9 | 页面顶部通栏图 |
| 讲师紹介 teachers.html | 每位老师单独设置，见下方说明 | 竖版 3:4 | 讲师本人照片 |
| 授业について lessons.html | `photo-lessons.jpg` | 横版 16:9 | "レッスンの雰囲気"旁边的配图 |
| 料金プラン pricing.html | `photo-pricing.jpg` | 横版 21:9 | 页面顶部通栏图 |
