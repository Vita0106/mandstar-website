...
| 首页 index.html | `bg-hero.jpg` | 横版，1920×1080px | 顶部大标题区域的背景图（会叠加一层紫色渐变） |
| 首页 index.html | `photo-hero.jpg` | 竖版 4:5 | 顶部大图，生徒がレッスンを楽しんでいる写真 |
